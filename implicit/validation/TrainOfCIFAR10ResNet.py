...
resume = None
#resume = '/home/beeperman/Projects/ImplicitLayers/validation/pretrained_models/resnet56-4bfd9763.th'
#resume = '/home/beeperman/Projects/ImplicitLayers/implicit/validation/save_temp/model.th'
name = "ResNet56"
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch > 0 and epoch % args.save_every == 0:
            ...
            }, is_best, filename=os.path.join(args.save_dir, '{}checkpoint.th'.format(name)))

        save_checkpoint({
            'state_dict': model.state_dict(),
            'best_prec1': best_prec1,
        }, is_best, filename=os.path.join(args.save_dir, '{}model.th'.format(name)))
