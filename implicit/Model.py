...
class SequentialBlockModel(torch.nn.Module):
    ...
    def getImplicitModel(self, sample_input):
        ...
        # Make D
        D = bmat([[coo_matrix((out_size, in_size)), b_list[0]]]) if self.populate_C else coo_matrix((out_size, in_size + 1)) # the bias term is added.. Not sure how to implement rnn.
